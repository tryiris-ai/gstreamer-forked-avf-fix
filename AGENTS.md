# AGENTS.md — gstreamer-forked-avf-fix
...
~/iris/ai.knowledge/rules/gstreamer-forked-avf-fix/INDEX.md  (if exists)
~/iris/ai.knowledge/knowledge/global/INDEX.md
~/iris/ai.knowledge/knowledge/gstreamer-forked-avf-fix/INDEX.md  (if exists)
```
...
Agent mistake → `/iris-rule global|gstreamer-forked-avf-fix {rule}`
Explained something new → `/iris-learn global|gstreamer-forked-avf-fix {context}`
